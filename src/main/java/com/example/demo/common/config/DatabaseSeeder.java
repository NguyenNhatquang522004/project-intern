...
public class DatabaseSeeder implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) {
        ...
        leaveBalanceRepository.findByEmployeeAndLeaveTypeAndYear(juniorDev1, annualLeave, 2025)
                .ifPresent(lb -> {
        ...
        leaveBalanceRepository.findByEmployeeAndLeaveTypeAndYear(seniorDev2, sickLeave, 2025)
                .ifPresent(lb -> {
        ...
        leaveBalanceRepository.findByEmployeeAndLeaveTypeAndYear(juniorDev2, annualLeave, 2025)
                .ifPresent(lb -> {
        ...
        leaveBalanceRepository.findByEmployeeAndLeaveTypeAndYear(hrStaff2, sickLeave, 2025)
                .ifPresent(lb -> {
        ...
        // Lịch sử duyệt cho Request 2 (APPROVED) — 1 cấp duyệt (sick leave buổi sáng)
        approvalHistoryRepository.save(ApprovalHistory.builder()
        ...
        approvalHistoryRepository.save(ApprovalHistory.builder()
                ...
                .level(1)
                .action("REJECTED")
                .comment("Tháng 5 là cao điểm công việc, không thể bố trí nghỉ 5 ngày liên tiếp. Vui lòng đăng ký lại vào tháng khác.")
                .build());
