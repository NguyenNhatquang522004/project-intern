...
public class DatabaseSeeder {
        ...
        // // Lịch sử duyệt cho Request 2 (APPROVED) — 1 cấp duyệt (sick leave buổi
        // sáng)
        // approvalHistoryRepository.save(ApprovalHistory.builder()
        ...
        // .level(1)
        // .action("REJECTED")
        // .comment("Tháng 5 là cao điểm công việc, không thể bố trí nghỉ 5 ngày liên
        // tiếp. Vui lòng đăng ký lại vào tháng khác.")
        // .build());
